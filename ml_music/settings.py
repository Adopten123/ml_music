"""
Django settings for ml_music project.
...
ALLOWED_HOSTS = ['127.0.0.1', '45.67.59.245', 'www.ml_music.ru', 'ml_music.ru', 'ml_music.ru:8000']
INSTALLED_APPS = []
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'player.context_processors.user_playlists',
            ],
        },
    },
]

WSGI_APPLICATION = 'ml_music.wsgi.application'
